...
function _fnGetTitleRow(iIndex)
{
	...
	oRowLayout.push("<table dir='rtl' cellspacing='1' cellpadding='0' border='0' class='calendarTable_' onMouseDown=\"_fnMoveDivAbove('"+iIndex+"')\">");
	oRowLayout.push("<tr>");
	...
	oRowLayout.push("<a href=\"javascript:_fnClearValue('"+iIndex+"')\" title='נקה תאריך' class='linksButton_'>C</a></td>");
	oRowLayout.push("<td align='right' valign='middle' class='titleRow_'>");
...
function _fnGetYearRow(iIndex)
{
	...
	oRowLayout.push("<tr dir='rtl'>");
	oRowLayout.push("<td align='center' valign='middle' colspan='"+oCalendarArray['Day'].length+"' class='yearHeadingRow_'>");

	oRowLayout.push("<table dir='rtl' cellspacing='0' cellpadding='0' border='0' width='100%' class='yearHeadingRow_'>");
	oRowLayout.push("<tr>");
	...
	oRowLayout.push(" title='שנה קודמת "+iPreviousYear+"' class='linksCalendar_'>&lt;</a></td>");
	oRowLayout.push("<td align='center' valign='middle'>");
	oRowLayout.push(iYear);
	oRowLayout.push("</td>");
	oRowLayout.push("<td align='center' valign='middle' width='12'>");
	oRowLayout.push("<a href=\"javascript:_fnShowYears('"+iIndex+"')\" title='בחר שנה' class='linksCalendar_' style='font-size:10px'>v</a></td>");
	oRowLayout.push("<td align='center' valign='middle' width='15'>");
	oRowLayout.push("<a href=\"javascript:_fnGetSelectedYear('"+iIndex+"', '"+iNextYear+"')\"");
	oRowLayout.push(" title='שנה הבאה "+iNextYear+"' class='linksCalendar_'>&gt;</a></td>");
	oRowLayout.push("</tr>");
	oRowLayout.push("</table>");
...
function _fnGetSelectedYearRows(iIndex, sPrevious, sNext)
{
	...
	oLayout.push("<table dir='rtl' cellspacing='0' cellpadding='1' border='0' width='100%'>");
	...
	oLayout.push("<td align='center' valign='middle'>בחר שנה</td>");
	oLayout.push("<td align='center' valign='middle' width='15'>");
